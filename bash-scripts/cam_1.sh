...
INPUT='-fflags flush_packets -rtsp_transport  tcp -i '$1
...
while :
do
ffmpeg $INPUT -fflags flush_packets -max_delay 2 -flags -global_header -hls_time 2 -hls_list_size 3 -vcodec copy -y $PROJECT_PATH'/video_cam_'$2'/index.m3u8 -segment_list_type m3u8'
done